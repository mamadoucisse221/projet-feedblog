...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSql = "INSERT INTO utilisateurs (prenom, nom, email, mot_de_passe) VALUES ('$prenom', '$nom', '$email', '$password')";

    if (mysqli_query($conn, $insertSql)) {
        // Insertion réussie, rediriger vers la page de connexion
